...
# Self-locating: resolve scripts/ relative to this skill, wherever the repo is cloned.
# If importing from elsewhere, set PIXEL_ART_SKILL to this SKILL.md's directory.
_here = Path(os.environ.get("PIXEL_ART_SKILL", Path(__file__).resolve().parent))
