...
description: Use when completing a task, implementing a major feature, or preparing to merge after tests and verification. Request an independent review that checks requirements, quality, security, and regression risk before final integration.
changelog:
  - "2026-08-15: Clarified prerequisite testing/verification and final integration role."
version: 1.1.0
