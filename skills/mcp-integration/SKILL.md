...
- **`stdio` (Local Process):** For executing local servers or tools as child processes. Ideal for custom servers, file system access, and local database connections. Codex manages the process lifecycle.
