...
description: PROACTIVELY use this agent when experiments are started, modified, or when results need analysis. Trigger when feature flags are introduced, A/B tests deployed, experiment milestones reached, or data-driven product decisions are needed.
color: blue
---
