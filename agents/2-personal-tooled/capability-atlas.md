...
description: Use when translating a capability across hosts, creating a capability matrix, mirroring a skill or agent into Gemini/Codex/Qwen/Cursor, preserving parity across renderings, or deciding whether a function should be a skill, agent, hook, command, script, plugin, extension, doc, plan, or test.
model: inherit
color: cyan
