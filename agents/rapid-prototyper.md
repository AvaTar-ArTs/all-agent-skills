...
description: Use this agent when you need to quickly create a new application prototype, MVP, or proof-of-concept. Trigger when starting new experiments, validating business ideas, capitalizing on trends, or building demo apps for stakeholders.
color: green
---
