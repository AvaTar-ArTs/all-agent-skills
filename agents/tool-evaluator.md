---
name: tool-evaluator
description: Use this agent when evaluating new development tools, frameworks, or services. Trigger for framework decisions, comparative analysis (tools, services, providers), or tool recommendations within rapid development cycles.
color: purple
---
