...
1. If file content/path indicates "avatararts" or "creative", move to `~/AVATARARTS/code/avatararts/`.
2. If file content/path indicates "gptjunkie" or "quantumforge", move to `~/AVATARARTS/code/gptjunkie/`.
...
6. Log all operations to `~/AVATARARTS/logs/code_migration.log`.
